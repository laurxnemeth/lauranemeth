  ...
  return (
		<div id="first-section">
			<div id="top-section">
				...
				<span class="sub" onClick={() => setModalShow(true)}>
			...
			<div id="name-and-headshot">
				<div id="name-wrapper">
					<h1 className="name birthstone-font">hi! I 'm</h1>
					<h1 className="name birthstone-font">Laura</h1>
					<h1 className="name birthstone-font">Nemeth</h1>
				</div>
				<div id="wrap">
